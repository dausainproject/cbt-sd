...
export const metadata = {
  title: "e-Asesmen | CBT SD",
  description: "Platform ujian online untuk sekolah dasar tahun pelajaran 2025/2026.",
}

export default function LandingPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex flex-col items-center justify-center p-6 font-sans">
      
      {/* Heading */}
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-extrabold text-slate-800 mb-4">
          e-Asesmen Sekolah Dasar
        </h1>
        <p className="text-slate-500 text-lg">
          Sistem Ujian Berbasis Komputer Tahun Pelajaran 2025/2026
        </p>
      </div>
      ...
      <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        ...
        <div className="bg-white rounded-[2rem] p-10 shadow-xl shadow-slate-200/60 flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl group border border-slate-100">
          ...
          <p className="text-slate-500 leading-relaxed mb-10 text-lg">
            Manajemen data peserta didik, bank soal, dan monitoring ujian secara real-time.
          </p>

          <Link
            href="/admin/login"
            className="mt-auto w-full py-4 px-6 border-2 border-rose-500 text-rose-500 font-bold rounded-2xl flex items-center justify-center gap-2 hover:bg-rose-500 hover:text-white transition-all"
          >
            Masuk Portal →
          </Link>
        </div>
        ...
        <div className="bg-white rounded-[2rem] p-10 shadow-xl shadow-slate-200/60 flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl group border border-slate-100">
          ...
          <p className="text-slate-500 leading-relaxed mb-10 text-lg">
            Akses ujian online dan lihat hasil evaluasi mandiri dengan cepat dan mudah.
          </p>

          <Link
            href="/peserta/login"
            className="mt-auto w-full py-4 px-6 border-2 border-amber-500 text-amber-500 font-bold rounded-2xl flex items-center justify-center gap-2 hover:bg-amber-500 hover:text-white transition-all"
          >
            Masuk Portal →
          </Link>
        </div>
      ...
      {/* Footer */}
      <footer className="mt-20 text-slate-400 font-medium text-sm text-center">
